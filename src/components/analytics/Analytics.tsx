 ...
 *
 * Each block renders only when its env var is set, so a deployment without IDs ships no tags.
 * TikTok is the primary sales channel for this business, so its pixel matters most here.
 *
 * Funnel events are fired from the storefront via `track()` in src/lib/analytics.ts.
 */
